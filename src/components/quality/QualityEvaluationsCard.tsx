    ...
    <div style={{
      ...
      <div style={{ display: "grid", gridTemplateColumns: "auto 1fr auto", gap: 10, alignItems: "center", flexShrink: 0 }}>
        <div style={{ textAlign: "center", minWidth: 60 }}>
          <div style={{ fontSize: 22, fontWeight: 800, color: "#fbbf24", fontVariantNumeric: "tabular-nums", lineHeight: 1 }}>
        ...
        <div style={{
          ...
          {showCompactBtn && (
            <button
              ...
              style={{ fontSize: 10, padding: "2px 6px", color: "#fbbf24", borderColor: "#fbbf2455" }}
            >
              Compactar
            </button>
          )}
