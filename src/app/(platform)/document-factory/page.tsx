...
export default function DocumentFactoryPage() {
  ...
  const canView = effective ? hasPermission(effective, "document_factory", "view", rbac.roles) : false;
  if (!canView) return <AccessLockedCard screen="document_factory" reason="Document Factory requiere rol con permiso de visualización." />;

  return <DocumentFactoryCenter />;
}
