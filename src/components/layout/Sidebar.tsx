  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav" aria-label="Módulos">
        ...
        {renderSection("AMS avanzado", ["support-desk", "agent-lab", "voice-calls", "knowledge", "playbooks", "document-factory", "quality-evaluator", "escalation-n2", "testing-intelligence", "tickets", "integrations", "sap-readonly", "meetings"])}
