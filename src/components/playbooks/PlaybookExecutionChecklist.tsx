  ...
  return (
    <div className="col" style={{ gap: 10 }}>
            ...
            <div className="row" style={{ gap: 10, alignItems: "flex-start" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div className="row" style={{ gap: 6, fontSize: 10.5, color: "var(--text-dim)", marginTop: 4, flexWrap: "wrap" }}>
                  ...
                  {step.evidenceRequired && <span style={{ color: "#8a6d00" }}>📎 evidencia</span>}
                </div>
                <textarea value={note}
      ...
      <div className="row" style={{ gap: 8, marginTop: 10, flexWrap: "wrap" }}>
        <button className="btn ghost" onClick={() => onAbandon(execution.id)} style={{ borderColor: "#fa4d56", color: "#da1e28" }}>
          ✕ Abandonar
        </button>
