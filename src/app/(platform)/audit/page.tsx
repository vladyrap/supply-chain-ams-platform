...
export default function AuditPage() {
  ...
  const canView = effective ? hasPermission(effective, "audit_trail", "view", rbac.roles) : false;
  if (!canView) return <AccessLockedCard screen="audit_trail" reason="Audit Trail requiere rol con permiso de visualización." />;

  return <GlobalAuditCenter />;
}
