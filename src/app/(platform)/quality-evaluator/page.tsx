...
export default function QualityEvaluatorPage() {
  ...
  const canView = effective ? hasPermission(effective, "quality_evaluator", "view", rbac.roles) : false;
  if (!canView) return <AccessLockedCard screen="quality_evaluator" reason="Quality Evaluator requiere rol con permiso de visualización." />;

  return <QualityEvaluatorCenter />;
}
