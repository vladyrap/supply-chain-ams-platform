...
export default function TimeEstimatorPage() {
  ...
  const canView = effective ? hasPermission(effective, "time_estimator", "view", rbac.roles) : false;
  if (!canView) {
    return <AccessLockedCard screen="time_estimator" reason="El Estimador de Tiempos requiere rol con permiso de visualización." />;
  }

  return <TimeEstimatorCenter />;
}
