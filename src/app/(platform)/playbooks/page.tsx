...
export default function PlaybooksPage() {
  ...
  const canView = effective ? hasPermission(effective, "playbooks_ams", "view", rbac.roles) : false;
  if (!canView) {
    return <AccessLockedCard screen="playbooks_ams" reason="Los Playbooks AMS requieren al menos rol con permiso de visualización." />;
  }

  return <PlaybooksCenter />;
}
