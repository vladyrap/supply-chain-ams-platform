...
// =============================================================================
// BuilderView — tab 🛠️ Crear Agente del módulo único /agent-hub (v1.3 onda 5.1)
// =============================================================================
...
// Modo edición: /agent-hub?tab=builder&id=<agentId> (solo agentes propios no-verified).
// =============================================================================
  ...
  if (notFound) {
    return (
      <div className="card" style={{ padding: 40, textAlign: "center" }}>
        ...
        <Link href="/agent-hub?tab=library" className="btn primary">← Volver a la Biblioteca</Link>
      </div>
    );
  }
